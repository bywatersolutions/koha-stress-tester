...
//    RUN CONFIG block below, then click Run. ( Anonymous - no login. )
// ══════════════════════════════════════════════════════════════════════
// ─── RUN CONFIG ( edit these ) ────────────────────────────────────────
const OPAC_URL = __ENV.OPAC_URL || "https://kohadev.localhost"; // <<< SET: public catalog URL of the server to test
const OPAC_SEARCHES_PER_HOUR = parseFloat(__ENV.OPAC_SEARCHES_PER_HOUR) || 0; // <<< SET: peak catalog searches/hour ( e.g. 12929 )
// ──────────────────────────────────────────────────────────────────────
...
// OPAC_SEARCHES_PER_HOUR ( in RUN CONFIG above ) is the open-model target -
// actual opac-search.pl requests/hour, converted to a session arrival rate
